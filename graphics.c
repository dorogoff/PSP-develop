...
void drawCircle(int x0, int y0, int radius, Color color) {
		...
		putPixelScreen(color, x0, y0 + radius);
		putPixelScreen(color, x0, y0 - radius);
		putPixelScreen(color, x0 + radius, y0);
		putPixelScreen(color, x0 - radius, y0);
		...
		while(x < y) {
			...
			ddF_x += 2;
			f += ddF_x + 1;    
			putPixelScreen(color, x0 + x, y0 + y);
			putPixelScreen(color, x0 - x, y0 + y);
			putPixelScreen(color, x0 + x, y0 - y);
			putPixelScreen(color, x0 - x, y0 - y);
			putPixelScreen(color, x0 + y, y0 + x);
			putPixelScreen(color, x0 - y, y0 + x);
			putPixelScreen(color, x0 + y, y0 - x);
			putPixelScreen(color, x0 - y, y0 - x);
	...
	void drawFilledCircle(int x0, int y0, int radius, Color color) {
		...
		drawLineScreen(x0, y0 - radius, x0, y0 + radius, color);
		drawLineScreen(x0 - radius, y0, x0 + radius, y0, color);
		...
		while(x < y) {
			...
			drawLineScreen(x0 + x, y0 - y, x0 + x, y0 + y, color);
			drawLineScreen(x0 + y, y0 - x, x0 + y, y0 + x, color);
			drawLineScreen(x0 - x, y0 - y, x0 - x, y0 + y, color);
			drawLineScreen(x0 - y, y0 - x, x0 - y, y0 + x, color);
