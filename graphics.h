 ...
 *
 * @param x0 - X position of center circle
 * @param y0 - Y position of center circle
 * @param radius - radius of circle
 * @param color - new color for the pixels
 */
extern void drawCircle(int x0, int y0, int radius, Color color);
 ...
 * @param color - new color for the pixels
 */
extern void drawFilledCircle(int x0, int y0, int radius, Color color);
